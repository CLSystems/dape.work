        ...
        <div class="flex items-center space-x-4">
            ...
            <!--<form action="/search" method="get">
                <input
                    type="search"
                    name="q"
                    placeholder="Search Elasticsearch errors…"
                    minlength="2"
                    required
                >
            ...
            @else
                <div class="flex items-center space-x-2">
                    <a href="{{ route('login') }}" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Login</a>
                    <a href="{{ route('register') }}" class="text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 px-3 py-1.5 rounded-md transition-colors">Register</a>
                </div>
            @endauth
        </div>
    </div>
