...
class GenerateKnowledge extends Command
{
    protected $signature = 'generate:knowledge {--limit=3}';

    protected $description = 'Generate knowledge entries from generation seeds';
